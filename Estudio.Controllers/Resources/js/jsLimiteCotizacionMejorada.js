...
(function () {
    localStorage.pagina = 'LimiteCotizacionMejorada';
...
function doSuccessBuscarVigencia(result) {
    if (result.IsOk) {
        if (result.Message == "No se encontro información") {
            ...
            //if (Vigencia.Minimo_TirInmediatas != null && Vigencia.Minimo_TirInmediatas > 0) {
                document.getElementById("txtMinTIRInmediatas").value = parseFloat(Vigencia.Minimo_TirInmediatas).toFixed(2);
            //}
            //else
            //{
            //    document.getElementById("txtMinTIRInmediatas").value = 0.00;
            //}
            //Perdida
