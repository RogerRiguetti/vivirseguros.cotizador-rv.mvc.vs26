(function () {
    ...
    if ($("#PermissionCreate").val().toLowerCase() != "true") {
        $('#btnAdd').prop("href", "#");
                ...
                "mRender": function (data, type, full) {
                    ...
                    return ($("#PermissionDetails").val().toLowerCase() === "true" ?
                        ("<div class='row'><div class='col-xs-4'><a  href=\"javascript:Details('" + full.Id + "');\"><i class='fa fa-search fa-lg'></i></a></div>"
                            ...
                            +
                            ($("#PermissionDelete").val().toLowerCase() === "true" ?
