...
{
    public class CargaActivosController : Controller
    {
        static string mensaje;
        private static readonly ILog _log = LogManager.GetLogger(MethodBase.GetCurrentMethod().DeclaringType);
        CargaActivosLogic _DatosExcel = new CargaActivosLogic();
        ...
        public ActionResult UploadFile(HttpPostedFileBase file)
        {
            ...
            if (file != null)
            {
                _log.Info("****************** Nueva carga de carga de activos*******************");
        ...
        private void UploadRecordsToDataBase(string fileName)
        {
                    ...
                    using (var reader = ExcelReaderFactory.CreateReader(stream))
                    {
                        ...
                        while (reader.Read())
                        {
                            ...
                            if (i == 0)
                            {
                                ...
                                query += "UPDATE PR_TMAE_ACTIVOS_ASA SET ";
                            ...
                            if (i >= 3)
                            {
                                query += "\nINSERT INTO PR_TMAE_ACTIVOS_ASA (FEC_INIVIG, FEC_TERVIG , COD_MONEDA, COD_TIPREAJUSTE, NUM_MES, MTO_VALOR)VALUES('";
                        ...
                        var resultado = _DatosExcel.CargarCargaActivos(query);
            ...
            {
                _log.Info("Error en la lectura del archivo para la Carga Masiva de Activos: " + ex.Message);
                mensaje = "Error en lectura de archivo para carga masiva: " + ex.Message;
            }
        ...
        public ActionResult CargaTabla(string fecha)
        {
            ...
            var resultado = _DatosExcel.CargarTablaCargaActivosReservas(Fec.ToString("yyyyMMdd"));
