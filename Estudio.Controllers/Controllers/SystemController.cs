...
namespace Estudio.Controllers.Controllers
{
    public class SystemController : Controller
    {
        ...
        public ActionResult Delete(int id)
        {
            ...
            {
                _res = new SystemModel().Delete(id);
            }
        ...
        [HttpPost]
        public ActionResult Create([Bind(Include = "Id, Description")] gzSystem system)
        {
            Response _res = null;

            if (ModelState.IsValid)
            {
                _res = new SystemModel().Create(system);
            }
            return Json(_res, JsonRequestBehavior.AllowGet);
        }
        ...
        [HttpPost]
        public ActionResult Edit([Bind(Include = "Id, Description")] gzSystem system)
        {
            Response _res = null;

            if (ModelState.IsValid)
            {
                _res = new SystemModel().Edit(system);
            }
            return Json(_res, JsonRequestBehavior.AllowGet);
        }
        #endregion
        ...
        {
            return Json(new { data = new SystemModel().Search(description, active) }, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            ViewBag.UserLogin = new EstudioController().ValidateSession();
            return View(new SystemModel().Details(id));
