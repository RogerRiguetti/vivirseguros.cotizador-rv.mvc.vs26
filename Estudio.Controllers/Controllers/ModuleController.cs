...
namespace Estudio.Controllers.Controllers
{
    public class ModuleController : Controller
    {
        ...
        public ActionResult Delete(int id)
        {
            ...
            {
                _res = new ModuleModel().Delete(id);
            }
        ...
        [HttpPost]
        public ActionResult Create([Bind(Include = "Id, Description, SystemId")] gzModule Module)
        {
            Response _res = null;

            if (ModelState.IsValid)
            {
                _res = new ModuleModel().Create(Module);
            }
            return Json(_res, JsonRequestBehavior.AllowGet);
        }
        ...
        [HttpPost]
        public ActionResult Edit([Bind(Include = "Id, Description, SystemId")] gzModule Module)
        {
            Response _res = null;

            if (ModelState.IsValid)
            {
                _res = new ModuleModel().Edit(Module);
            }
            return Json(_res, JsonRequestBehavior.AllowGet);
        }
        #endregion
        ...
        {
            return Json(new { data = new ModuleModel().Search(description, active) }, JsonRequestBehavior.AllowGet);
        }
        ...
        {
            ViewBag.UserLogin = new EstudioController().ValidateSession();
            return View(new ModuleModel().Details(id));
