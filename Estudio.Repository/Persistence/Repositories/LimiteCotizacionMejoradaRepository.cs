...
{
    public class LimiteCotizacionMejoradaRepository
    {
        /// <summary>
        /// osvaldo valdez
        /// 29-08-18
        ...
        public List<Departamento> TipoDepartamento()
        {
            try
            {
                ...
                return VCEDBContext<Departamento>.CallStoreProcedure(StoredProcedures.CO_CatalogosLimiteCotizacionMejorada, parameters, x => new Departamento
                {
        ...
        public List<RangosTasaVenta> RangosTasa()
        {
            try
            {
                ...
                return VCEDBContext<RangosTasaVenta>.CallStoreProcedure(StoredProcedures.CO_CatalogosLimiteCotizacionMejorada, parameters, x => new RangosTasaVenta
                {
        ...
        /// <returns></returns>
        public LimiteCotizacionMejorada ConsultaInfo(DateTime fechaIni,string codMoneda, int reajuste,int departamento)
        {
            try
            {
                var parameters = new List<SqlParameter>();
                ...
                return VCEDBContext<LimiteCotizacionMejorada>.CallStoreProcedure(StoredProcedures.CO_CatalogosLimiteCotizacionMejorada, parameters, x => new LimiteCotizacionMejorada
                {
                    ...
                    Minimo_TirInmediatas = x.GetDecimal(6),
                    ComisionDiferida = x.GetDecimal(7),
                    ComisionInmediata = x.GetDecimal(8),
                }).FirstOrDefault();
        ...
        public LimiteCotizacionMejorada Grabar( string clave,LimiteCotizacionMejorada informacion, DateTime fechaIni, DateTime fechaFin,string usuario)
        {
            try
            {
                ...
                parameters.Add(VCEDBContext<RowAffected>.AddParams("@vMinimo_TirInmediatas", SqlDbType.Decimal, informacion.Minimo_TirInmediatas, ParameterDirection.Input));
                ...
                parameters.Add(VCEDBContext<RowAffected>.AddParams("@vDiferida_Com", SqlDbType.Decimal, informacion.ComisionDiferida, ParameterDirection.Input));
                parameters.Add(VCEDBContext<RowAffected>.AddParams("@vInmediata_Com", SqlDbType.Decimal, informacion.ComisionInmediata, ParameterDirection.Input));
                //datos Perdida 
        ...
        /// <returns>retorna las fechas para su validacion</returns>
        public LimiteCotizacionMejorada GrabarTasaVenta(string clave, LimiteCotizacionMejorada informacion, DateTime fechaIni, DateTime fechaFin, string usuario,string CodPension, decimal Minimo_TV , decimal Maximo_TV)
        {
            try
            {
                DateTime fecha = DateTime.Now;
        ...
        public List<Periodo> ListaPeriodos(string vlMoneda, int vlReajuste,int departamento)
        {
            try
            {
                ...
                return VCEDBContext<Periodo>.CallStoreProcedure(StoredProcedures.CO_CatalogosLimiteCotizacionMejorada, parameters, x => new Periodo
                {
        ...
        public List<LimiteCotizacionMejorada> RangosTasaVenta(DateTime fechaIni, string codMoneda, int reajuste, int departamento)
        {
            try
            {
                var parameters = new List<SqlParameter>();
        ...
        public LimiteCotizacionMejorada EliminarCorizacionMejorada(string clave, DateTime fechaIni, DateTime fechaFin, LimiteCotizacionMejorada informacion)
        {
            try
            {
                var parameters = new List<SqlParameter>();
        ...
        public void EjecutarScript(string script)
        {
            try
            {
                ...
                VCEDBContext<LimiteCotizacionMejorada>.CallSelectStatementConection(conexion, script, x => new LimiteCotizacionMejorada
                {
                }).FirstOrDefault();
            }
            catch (Exception ex)
