...
{
    public class LimiteCotizacionInicialRepository
    {
        /// <summary>
        /// osvaldo valdez
        /// 29-08-18
        ...
        public List<Departamento> TipoDepartamento()
        {
            try
            {
                ...
                return VCEDBContext<Departamento>.CallStoreProcedure(StoredProcedures.CO_CatalogosLimiteCotizacionInicial, parameters, x => new Departamento
                {
        ...
        public List<RangosTasaVenta> RangosTasa()
        {
            try
            {
                ...
                return VCEDBContext<RangosTasaVenta>.CallStoreProcedure(StoredProcedures.CO_CatalogosLimiteCotizacionInicial, parameters, x => new RangosTasaVenta
                {
        ...
        /// <returns></returns>
        public LimiteCotizacionInicial ConsultaInfo(DateTime fechaIni, string codMoneda, int reajuste, int departamento)
        {
            try
            {
                var parameters = new List<SqlParameter>();
                ...
                return VCEDBContext<LimiteCotizacionInicial>.CallStoreProcedure(StoredProcedures.CO_CatalogosLimiteCotizacionInicial, parameters, x => new LimiteCotizacionInicial
                {
        ...
        public LimiteCotizacionInicial Grabar(string clave, LimiteCotizacionInicial informacion, DateTime fechaIni, DateTime fechaFin, string usuario)
        {
            try
            {
        ...
        /// <returns>retorna las fechas para su validacion</returns>
        public LimiteCotizacionInicial GrabarTasaVenta(string clave, LimiteCotizacionInicial informacion, DateTime fechaIni, DateTime fechaFin, string usuario, string CodPension, decimal Minimo_TV, decimal Maximo_TV)
        {
            try
            {
                DateTime fecha = DateTime.Now;
        ...
        public List<Periodo> ListaPeriodos(string vlMoneda, int vlReajuste, int departamento)
        {
            try
            {
                ...
                return VCEDBContext<Periodo>.CallStoreProcedure(StoredProcedures.CO_CatalogosLimiteCotizacionInicial, parameters, x => new Periodo
                {
        ...
        public List<LimiteCotizacionInicial> RangosTasaVenta(DateTime fechaIni, string codMoneda, int reajuste, int departamento)
        {
            try
            {
                var parameters = new List<SqlParameter>();
        ...
        public LimiteCotizacionInicial EliminarCorizacionMejorada(string clave, DateTime fechaIni, DateTime fechaFin, LimiteCotizacionInicial informacion)
        {
            try
            {
                var parameters = new List<SqlParameter>();
        ...
        public void EjecutarScript(string script)
        {
            try
            {
                ...
                VCEDBContext<LimiteCotizacionInicial>.CallSelectStatementConection(conexion, script, x => new LimiteCotizacionInicial
                {
                }).FirstOrDefault();
            }
            catch (Exception ex)
