...
namespace Estudio.Repository.Core.Domain
{
    public class ActualizaInfOfi
    {
        ...
        public string MTO_PRIUNIDIF { get; set; }
        public string PRC_PERCON { get; set; }
        public string PRC_TASATIR { get; set; }
        public string PRC_TASAVTA { get; set; }
        public string IND_FILTROCOTIZA { get; set; }
        public string COD_ESTCOT { get; set; }
        public string COD_RECHAZO { get; set; }
        public string Err_Descrip { get; set; }
        public string Ind_MejEx { get; set; }
    }
}
