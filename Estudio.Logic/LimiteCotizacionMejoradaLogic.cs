...
namespace Estudio.Logic
{
    public class LimiteCotizacionMejoradaLogic
    {
        ...
        public string insertCargaMasiva(LimiteCotizacionMejorada datos, string usuario, string tipoRenta)
        {
            ...
            string fecfinTir = "UPDATE PT_TVAL_MINMAXTIR_MEJ SET FEC_TERMINMAX = '" + fecha.ToString("yyyyMMdd") + "' WHERE FEC_TERMINMAX = '99991231'";
            string fecfinPer = "UPDATE PT_TVAL_MINMAXPER_MEJ SET FEC_TERMINMAX = '" + fecha.ToString("yyyyMMdd") + "' WHERE FEC_TERMINMAX = '99991231'";
            string fecfinTas = "UPDATE PT_TVAL_MINMAXTAS_MEJ SET FEC_TERMINMAX = '" + fecha.ToString("yyyyMMdd") + "' WHERE FEC_TERMINMAX = '99991231'";
